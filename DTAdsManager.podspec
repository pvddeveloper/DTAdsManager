...
Pod::Spec.new do |s|
  s.name             = 'DTAdsManager'
  s.version          = '0.1.0'
  s.summary          = 'A short description of DTAdsManager.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/adx-developer/DTAdsManager'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'adx-developer' => 'pvddeveloper@gmail.com' }
  s.source           = { :git => 'https://github.com/adx-developer/DTAdsManager.git', :tag => s.version.to_s }
